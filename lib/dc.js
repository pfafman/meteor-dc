...
dc.baseMixin = function (_chart) {
    ...
    function sizeSvg () {
        var widthBuffer = 0;   // TEP: Issue with truncating axis allow customization
        if (_chart.svgWidthBuffer) {
            widthBuffer = _chart.svgWidthBuffer;
        }
        if (_svg) {
            _svg
                .attr('width', _chart.width() + widthBuffer) 
